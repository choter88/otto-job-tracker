...
interface JobCommentsPanelProps {
  job: Job;
...
export default function JobCommentsPanel({
  ...
  return (
    <div className={cn("flex h-full flex-col", className)}>
      ...
      <div className={cn("flex-1 overflow-y-auto p-4 space-y-4", listClassName)}>
        {isLoading ? (
      ...
      <div className={cn("p-4 border-t border-border", composerClassName)}>
